  ...
  return (
    <div className="neumorphic-card rounded-2xl p-6 hover-lift">
      <div className="text-center mb-6">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-2">Assess Your Progress</h2>
        <p className="text-sm text-gray-600">How do you feel about today's learning?</p>
      </div>
      ...
      <div className="mt-6 pt-4 border-t border-blue-100/50">
        <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-lg p-3">
          ...
          <p className="text-lg font-bold text-gray-800">4.2/5.0</p>
          <p className="text-xs text-gray-600">You're performing excellently!</p>
        </div>
      </div>
    </div>
  );
