    ...
    <DashboardLayout currentPage="help">
      <div className="h-full w-full p-6 space-y-8 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-[#1f1f1f] rounded-2xl p-6 shadow-md flex flex-col items-start space-y-2">
        ...
        {/* FAQ Section */}
        <div className="bg-white dark:bg-[#1f1f1f] rounded-2xl p-6 shadow-md">
        ...
        <div className="bg-white dark:bg-[#1f1f1f] rounded-2xl p-6 shadow-md space-y-4">
