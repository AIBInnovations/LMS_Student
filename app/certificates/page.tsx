...
import { Award, Download, Share2, Eye, Calendar, Star, Filter, Search, Trophy, Medal, Crown } from 'lucide-react';
                ...
                <div key={certificate.id} className="neumorphic-card p-6 hover-lift">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                    <div>
                      ...
                      <p className="font-medium text-[#333333]">{new Date(certificate.issueDate).toLocaleDateString()}</p>
                    </div>
                    <div>
